...
set ::bali::simulation::Para(PROJECT) {Lab1_2diag}
set ::bali::simulation::Para(PROJECTPATH) {C:/VK. skaitmenine/1 LD}
set ::bali::simulation::Para(FILELIST) {"C:/VK. skaitmenine/1 LD/impl1/Schema_1.vhd" }

...
--
-- Database: `sporto irangos prekyba`
--
...
(11.6, 2.8, 'didelis', 3.8, 5, 1, 1),
(71.6, 2.5, 'vidutinis', 4.9, 4, 1, 2),
(133.3, 4.3, 'didelis', 1.7, 3, 1, 3),
(7.9, 1.1, 'vidutinis', 4.7, 1, 1, 4),
(188.5, 4.1, 'mazas', 1.5, 3, 5, 5),
(44.8, 4.6, 'didelis', 2.2, 3, 3, 6),
...
('Gabspot', 'Nondisplaced fracture of medial phalanx of right index finger, subsequent encounter for fracture with routine healing', 1, 1, 1),
('Eare', 'Bipolar disorder, current episode manic without psychotic features', 2, 2, 2),
('Wordpedia', 'Osteonecrosis due to drugs, right ankle', 3, 3, 3),
('Yata', 'Periumbilic abdominal tenderness', 4, 4, 4),
('Devify', 'Exposure to other inanimate mechanical forces, subsequent encounter', 5, 5, 5),
('Wordpedia', 'Nondisplaced spiral fracture of shaft of left femur, subsequent encounter for open fracture type IIIA, IIIB, or IIIC with malunion', 6, 6, 6),
('Avaveo', 'Medial dislocation of right ulnohumeral joint, initial encounter', 7, 7, 7),
('Eimbee', 'Strain of flexor muscle, fascia and tendon of unspecified finger at wrist and hand level, initial encounter', 8, 8, 8),
('Realbuzz', 'Toxic effect of venom of black widow spider, intentional self-harm, sequela', 9, 9, 9),
('Agimba', 'Displaced fracture of proximal phalanx of right lesser toe(s), sequela', 10, 10, 10),
('Tambee', 'Toxic effect of dichloromethane, accidental (unintentional), sequela', 11, 11, 11),
('Brainbox', 'Adverse effect of tetracyclic antidepressants, subsequent encounter', 12, 12, 12),
('Skaboo', 'Fall on board (nonpowered) inflatable craft, subsequent encounter', 13, 13, 13),
('Wordpedia', 'Poisoning by antitussives, assault', 14, 14, 14),
('Flipstorm', 'Malignant neoplasm of overlapping sites of heart, mediastinum and pleura', 15, 15, 15),
('Livefish', 'Other specified intracranial injury with loss of consciousness greater than 24 hours without return to pre-existing conscious level with patient surviving, initial encounter', 16, 16, 16),
('Gabtype', 'Obstruction due to foreign body accidentally left in body following kidney dialysis, subsequent encounter', 17, 17, 17),
('Brainsphere', 'Problem related to life management difficulty, unspecified', 18, 18, 18),
...
('Skinte', 'Puncture wound of abdominal wall without foreign body, unspecified quadrant without penetration into peritoneal cavity', 28, 28, 28),
('Flipbug', 'Dislocation of unspecified parts of left shoulder girdle, initial encounter', 29, 29, 29),
('Quinu', 'Concussion and edema of thoracic spinal cord, subsequent encounter', 30, 30, 30);
...
('2022-03-04', '2022-06-04', 950.6, 29),
('2022-03-27', '2022-06-27', 267.8, 11),
('2022-03-28', '2022-06-28', 485.7, 14),
('2022-04-15', '2022-07-15', 111.3, 22),
('2022-04-17', '2022-07-17', 831.7, 10),
('2022-05-28', '2022-08-28', 167, 24),
('2022-06-01', '2022-09-01', 998.5, 18),
('2022-06-02', '2022-09-02', 265.9, 7),
('2022-06-20', '2022-09-20', 938.4, 4),
('2022-07-26', '2022-10-26', 475.7, 6),
('2022-08-15', '2022-11-15', 295.8, 8),
('2022-08-17', '2022-11-17', 622.2, 23),
('2022-08-21', '2022-11-21', 61.9, 30),
('2022-08-29', '2022-11-29', 305.6, 15),
('2022-09-05', '2022-12-05', 511.6, 28),
('2022-09-24', '2022-12-24', 751.4, 21),
('2022-10-14', '2023-01-14', 901.1, 27),
('2022-10-22', '2023-01-22', 592.2, 12),
('2022-11-18', '2023-02-18', 443.9, 20),
('2022-11-20', '2023-02-20', 867.1, 1),
('2022-11-24', '2023-02-24', 448.6, 13),
('2022-12-07', '2023-03-07', 492.7, 25),
('2022-12-08', '2023-03-08', 786.4, 17),
('2022-12-18', '2023-03-18', 753.5, 3),
('2022-12-20', '2023-03-20', 452.7, 9),
('2023-01-03', '2023-04-03', 536.7, 5),
('2023-02-01', '2023-05-01', 980.4, 16),
('2023-02-11', '2023-05-11', 219.6, 19),
('2023-02-21', '2023-05-21', 271.7, 2),
...
(5277, '2023-02-15', 748.6, 6, 6, 5224641),
...
(1, 'Skimia', '4655375087', 'tmeffin0@google.ru', '9 Thierer Center'),
(2, 'Vidoo', '1587128507', 'eyusupov1@blog.com', '262 Westend Point'),
(3, 'Cogibox', '5695353973', 'tjentet2@cmu.edu', '38 Gateway Court'),
(4, 'Gabtune', '4965377779', 'yjans3@istockphoto.com', '87 Sachs Street'),
(5, 'Agivu', '7254651370', 'sbinch4@gnu.org', '82862 Fallview Street'),
(6, 'Blogtag', '4504888329', 'njohnson5@adobe.com', '6660 Bashford Court'),
(7, 'Edgetag', '3578259365', 'bstrathdee6@yahoo.co.jp', '092 Lerdahl Pass'),
...
(30, 'Kimia', '9759291655', 'klargant@myspace.com', '11562 Magdeline Avenue');
...
INSERT INTO `uzsakymai` (`uzsakymo_nr`, `uzsakymo_data`, `fk_darbuotojas`) VALUES
(1, '2022-08-20', 1),
(2, '2022-08-20', 2),
(3, '2022-04-18', 3),
(4, '2023-02-24', 4),
...
ALTER TABLE `perkamos_prekes`
  ADD PRIMARY KEY (`fk_uzsakymas`,`fk_preke`,`fk_prekes_kaina_galioja_nuo`),
  ADD KEY `nurodoma_uz` (`fk_preke`,`fk_prekes_kaina_galioja_nuo`);
...
ALTER TABLE `prekes`
  ...
  ADD KEY `tiekia` (`fk_tiekejas`),
  ADD KEY `priklauso` (`fk_parametras`);

--
-- Indexes for table `prekiu_kainos`
--
ALTER TABLE `prekiu_kainos`
  ADD PRIMARY KEY (`galioja_nuo`,`fk_preke`),
  ADD KEY `parduodama_uz` (`fk_preke`);
...
ALTER TABLE `perkamos_prekes`
  ...
  ADD CONSTRAINT `nurodoma_uz` FOREIGN KEY (`fk_preke`,`fk_prekes_kaina_galioja_nuo`) REFERENCES `prekiu_kainos` (`fk_preke`, `galioja_nuo`);
...
ALTER TABLE `prekes`
  ...
  ADD CONSTRAINT `tiekia` FOREIGN KEY (`fk_tiekejas`) REFERENCES `tiekejai` (`tiekejo_id`);

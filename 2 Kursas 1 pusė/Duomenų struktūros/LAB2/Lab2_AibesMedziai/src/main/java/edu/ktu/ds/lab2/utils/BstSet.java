...
public class BstSet<E extends Comparable<E>> implements SortedSet<E>, Cloneable {
    ...
    //// RELIZUOTAS CONTAINS ALL METODAS
    /**
    ...
    public Set<E> subSet(E element1, E element2) {
        ...
        if ( element1 == null || element2 == null){
            throw new IllegalArgumentException("Element1 and element2 is null in subSet(E element1, E element2)");
        }
        ...
        {
            E e = (E)Array[i];
            int cmp1 = c.compare(e, element1);
            int cmp2 = c.compare(e, element2);
